      ...
      <div className="flex-about">
        <div className="about-text">
          <p>
            ...
            complex problems. With a focus on web technologies such as HTML, CSS, and JavaScript. I enjoy 
            working on both the front-end and back-end of applications, and I am always looking for ways to 
            optimize performance, improve user experience, and ensure the highest level of code quality.
          </p>
          <p>Throughout my career, I have worked on a wide range of projects, from simple static websites to
            ...
            tools and frameworks, including Node.js. I am always eager to learn and explore new technologies, 
